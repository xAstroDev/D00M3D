...
echo " "
echo -e "\e[33m Welcome to [\e[1m\e[32mINF3CT0R\e[21m\e[31m V2\e[33m]"
echo " "
sleep 1
echo -e "\e[1m\e[33m============================================\e[21m"
echo " "
echo -e "\e[33m« Script by \e[36mThe C0DE BREAK3RZ\e[33m »"
echo " "
echo -e "\e[1m\e[33m••••••••••••••••••••••••••••••••••••••••••••\e[21m"
echo " "
sleep 1
echo -e "\e[92mChecking Packages.."
echo " "
echo -e "\e[1m\e[33m^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\e[21m"
sleep 2
...
echo -e "\e[1m\e[33m^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\e[21m"
    echo " " 
                    echo -e "\e[36m >>> STARTING INF3CT0R V2..."
                    echo " "
                    sleep 2
...
echo " "
echo -e "\e[93m\e[44m WARNING!"|pv -qL 20
echo -e "\e[44mTHIS TOOL IS MADE FOR     "|pv -qL 20
...
sleep 1
echo " "
echo -e "\e[32m[1]\e[32m VIRUS APPLICATIONS [BETA]"
echo " "
